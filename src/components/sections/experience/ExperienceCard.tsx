...
export default function ExperienceCard({ experience }: { experience: ExperienceItem }) {
  return (
    ...
    >
      <SpotlightCard
        leftAccent
        className="bg-white border border-[#ccc6bd] group-hover:border-[#b8b0a5] rounded-2xl p-6 md:p-8 shadow-[0_2px_8px_-2px_rgba(110,89,70,0.04)] group-hover:shadow-[0_16px_36px_-10px_rgba(134,81,48,0.12),0_4px_12px_-2px_rgba(134,81,48,0.06)] transition-all duration-300"
      >
