...
import { Globe, Bot, Brain, Sparkles } from "lucide-react";
...
export default function TechIcon({ name, className = "w-4 h-4" }: TechIconProps) {
  ...
  switch (normalized) {
    ...
    case "tensorflow":
      return <SiTensorflow className={`${className} text-[#FF6F00]`} />;
    case "fastapi":
      return <SiFastapi className={`${className} text-[#009688]`} />;
    case "scikit-learn":
      return <SiScikitlearn className={`${className} text-[#F7931E]`} />;
    case "pandas":
      return <SiPandas className={`${className} text-[#150458]`} />;
    case "numpy":
      return <SiNumpy className={`${className} text-[#013243]`} />;
    case "react":
      return <SiReact className={`${className} text-[#61DAFB]`} />;
    case "next.js":
    case "nextjs":
      return <SiNextdotjs className={`${className} text-[#000000]`} />;
    case "javascript":
    ...
    case "express.js":
    case "express":
      return <SiExpress className={`${className} text-[#000000]`} />;
    case "php":
    ...
    case "openai api":
    case "openai":
      return <OpenAiIcon className={`${className} text-[#10A37F]`} />;
    case "ai agent":
      return <Bot className={`${className} text-[#865130]`} />;
    case "deep learning":
    case "machine learning":
    case "ml":
    case "cnn":
    case "lstm":
      return <Brain className={`${className} text-[#865130]`} />;
    case "on-chain apis":
    case "rest apis":
    case "rest api":
    case "api":
      return <Globe className={`${className} text-[#865130]`} />;
    case "supabase":
      return <SiSupabase className={`${className} text-[#3ECF8E]`} />;
    case "flutter":
      return <SiFlutter className={`${className} text-[#02569B]`} />;
    case "dart":
      return <SiDart className={`${className} text-[#0175C2]`} />;
    case "tailwind css":
    case "tailwindcss":
    case "tailwind":
      return <SiTailwindcss className={`${className} text-[#06B6D4]`} />;
    case "railway":
      return <SiRailway className={`${className} text-[#0B0D0E]`} />;
    case "pytorch":
      return <SiPytorch className={`${className} text-[#EE4C2C]`} />;
    case "nginx":
      return <SiNginx className={`${className} text-[#009639]`} />;
    case "vercel":
      return <SiVercel className={`${className} text-[#000000]`} />;
    default:
      return <Sparkles className={`${className} text-[#865130]`} />;
  }
}
